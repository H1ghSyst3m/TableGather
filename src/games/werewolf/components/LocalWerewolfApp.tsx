      ...
      <>
        <WerewolfPlaySurface
          ...
          actions={{
            ...
            setDoctorHealTonight: (value) => setState((current) => (current ? setDoctorHealTonight(current, value) : current)),
...
function normalizeSavedGame(state: WerewolfState): WerewolfState {
  return {
    ...
    doctorHealUsed: state.doctorHealUsed ?? false,
    doctorHealTonight: state.doctorHealTonight ?? false,
